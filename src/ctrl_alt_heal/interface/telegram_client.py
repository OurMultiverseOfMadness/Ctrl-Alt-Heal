...
def send_telegram_message(
    chat_id: str, text: str, split_long: bool = True
) -> List[Dict[str, Any]]:
    """
    ...
    return client.send_message(chat_id, text, split_long)


def send_telegram_file(
    chat_id: str, file_content: Union[str, bytes], filename: str, caption: str = ""
) -> Dict[str, Any]:
    """
    Send a file to Telegram with robust error handling.
    ...
    """
    client = get_telegram_client()
    return client.send_file(chat_id, file_content, filename, caption)


def get_telegram_file_path(file_id: str) -> Optional[str]:
    """
    Get file path from Telegram file ID with robust error handling.
    ...
    """
    client = get_telegram_client()
    return client.get_file_path(file_id)
